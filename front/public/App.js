        ...
        task_form.addEventListener('submit', e => {
            ...
            if (task_name.value && task_description.value) {
                ...
                let jsonObject = {
                    ...
                    user: "Incognito DOE",
                    state: "Proposée",
                    picture: "public/images/profile/photo_passe.jpg",
...
function dropdown(element) {
    ...
    if (dropdown_element) {
        dropdown_element.addEventListener('click', e => {
            if ($_('.dashboard-nav-right-profile-item-dropdown').classList.contains('show')) {
                $_('.dashboard-nav-right-profile-item-dropdown').classList.remove('show');
            } else {
                $_('.dashboard-nav-right-profile-item-dropdown').classList.add('show');
            }
        });
