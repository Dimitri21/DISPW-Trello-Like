<section class="hero">
    <div class="hero-container">
        ...
        <div class="hero-right">
            ...
            <lottie-player src="https://assets6.lottiefiles.com/packages/lf20_rycdh53q.json"  background="transparent"  speed="1"  style="width: 300px; height: 300px;"  loop  autoplay></lottie-player>
        </div>
    </div>
</section>
